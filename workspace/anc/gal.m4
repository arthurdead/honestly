...
m4_define(API_BRIDGE_TYPE, PUBLIC)
API_BRIDGE(
	COMPONENTS/gal/m4/shared/__private/glyphset_funcs.hpp.m4,
	COMPONENTS/gal/cpp/public_headers/gal/__private/glyphset_funcs.pub.gen.hpp
)

m4_define(API_BRIDGE_TYPE, PRIVATE)
API_BRIDGE(
	COMPONENTS/gal/m4/private_impl/__private/glyphset_funcs.hpp.m4,
	COMPONENTS/gal/cpp/private_impl/__private/glyphset_funcs.priv.gen.hpp
)
...
DECLARE_DEPENDENCY(static_library, gal, `
	...
	m4_define(`LD_LIBS', -lpci -lfontconfig -lfreetype -lharfbuzz)
')
...
CXX_STATIC_LIBRARY(xcb,
	...
	COMPONENTS/gal/cpp/private_impl/xcb/graphic_context.cpp,
	COMPONENTS/gal/cpp/private_impl/xcb/glyph_set.cpp,
