m4_ifelse(CONFIGURATION, release, `
	m4_define(`__CPP_CXX_FLAGS', m4_defn(`__CPP_CXX_FLAGS') -Ofast)
	m4_define(`__CPP_FLAGS', m4_defn(`__CPP_FLAGS') -DNDEBUG)
')

m4_ifelse(CONFIGURATION, debug, `
	m4_define(`__CPP_CXX_FLAGS', m4_defn(`__CPP_CXX_FLAGS') -O0)
	m4_define(`__CXX_FLAGS', m4_defn(`__CXX_FLAGS') -fno-omit-frame-pointer -ggdb3)
	m4_ifelse(LIBC, crt, `', `
...
m4_ifelse(LIBCPP, libc++, `
	m4_define(`__CPP_FLAGS', m4_defn(`__CPP_FLAGS') -D_LIBCPP_ENABLE_NODISCARD -D_LIBCPP_ENABLE_THREAD_SAFETY_ANNOTATIONS)

	m4_ifelse(CONFIGURATION, debug, `
		m4_define(`__CPP_FLAGS', m4_defn(`__CPP_FLAGS') -D_LIBCPP_DEBUG=1)
	')
')

m4_ifelse(LIBCPP, libstdc++, `
	m4_define(`__CPP_FLAGS', m4_defn(`__CPP_FLAGS') -D_GLIBCXX_CONCEPT_CHECKS -D_GLIBCPP_CONCEPT_CHECKS)

	m4_ifelse(CONFIGURATION, debug, `
		m4_define(`__CPP_FLAGS', m4_defn(`__CPP_FLAGS') -D_GLIBCXX_DEBUG -D_GLIBCPP_DEBUG)
	')
	m4_ifelse(CONFIGURATION, release, `
		m4_define(`__CPP_FLAGS', m4_defn(`__CPP_FLAGS') -DNDEBUG -D_GLIBCXX_PARALLEL -D_GLIBCPP_PARALLEL)
	')
')
...
m4_define(`__CPP_CXX_FLAGS', m4_defn(`__CPP_CXX_FLAGS') -Wall -Wextra -pedantic -Wfatal-errors)
m4_ifelse(TOOLSET, llvm, `
	m4_define(`__CPP_CXX_FLAGS', m4_defn(`__CPP_CXX_FLAGS') -Weverything)
...
m4_define(`__CXX_FLAGS', m4_defn(`__CXX_FLAGS') -fpic -fvisibility=hidden)
