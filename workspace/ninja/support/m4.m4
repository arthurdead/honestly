...
rule m4
__HACK_SPACE`'command=m4 -EE -P $m4flags -I`'__SUPPORT_DIR -I$dir -D`__SUPPORT_DIR'=__SUPPORT_DIR $in > $out
rule m4_rem_white
__HACK_SPACE`'command=m4 -EE -P $m4flags -I`'__SUPPORT_DIR -I$dir -D`__SUPPORT_DIR'=__SUPPORT_DIR $in > $out && __SUPPORT_SCRIPT(remove_whitespace) $out
')