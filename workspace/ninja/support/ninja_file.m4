...
m4_ifdef(`EMSCRIPTEN', `
	m4_undefine(`__NEED_USER_INCLUDE')

	m4_define(`__CPP_FLAGS', m4_defn(`__CPP_FLAGS') -isystem /usr/lib/emscripten/system/include)
')
...
m4_ifdef(`WINE', `
	m4_define(`__CPP_FLAGS', m4_defn(`__CPP_FLAGS') -isystem /usr/include/wine/windows)
')

m4_ifdef(`__NEED_USER_INCLUDE', `
	m4_undefine(`__NEED_USER_INCLUDE')

	m4_define(`__CPP_FLAGS', m4_defn(`__CPP_FLAGS') -isystem /usr/include)
')
...
m4_ifdef(`EMSCRIPTEN', `
	...
	m4_define(__LD_IN_FLAGS_BASE, $1 $ldflags __LIBCPP_LIBS __LIBCPP_ABI_LIBS __INTERNAL_LIBS -lc __INTERNAL_LIBS)
	m4_define(__LD_IN_FLAGS_EXEC, __LD_IN_FLAGS_BASE($1))
')

m4_ifdef(`__LD_IN_DEFINED', `
	m4_undefine(`__LD_IN_DEFINED')
', `
	m4_define(__LD_IN_FLAGS_BASE, __LIBC_LIB_DIR/crti.o __LIBRT_LIB_DIR/__LIBRT_CRTBEGIN $1 $ldflags __LIBCPP_LIBS __LIBCPP_ABI_LIBS -lm __INTERNAL_LIBS -lc __INTERNAL_LIBS __LIBRT_LIB_DIR/__LIBRT_CRTEND __LIBC_LIB_DIR/crtn.o)

	m4_define(__LD_IN_FLAGS_EXEC, __LIBC_LIB_DIR/Scrt1.o __LD_IN_FLAGS_BASE($1))
')

m4_undefine(`__INTERNAL_LIBS')

m4_define(__LD_IN_FLAGS_LIB, __LD_IN_FLAGS_BASE($1))
...
')
m4_define(`__GENERATED_CPP_FLAGS', m4_defn(`__GENERATED_CPP_FLAGS') -Wno-undef -include __SUPPORT_DIR/thirdparty_fixes.hpp)
m4_define(`__GENERATED_CXX_FLAGS', m4_defn(`__GENERATED_CXX_FLAGS') -Wno-zero-as-null-pointer-constant -Wno-sign-conversion -Wno-non-virtual-dtor -Wno-shadow-field-in-constructor -Wno-shadow-field -Wno-comma -Wno-unreachable-code -Wno-unreachable-code-break -Wno-weak-vtables -Wno-missing-variable-declarations -Wno-exit-time-destructors -Wno-old-style-cast)

m4_ifdef(`ZAPCC', `
	m4_define(`__GENERATED_CXX_FLAGS', m4_defn(`__GENERATED_CXX_FLAGS') -Wno-conversion)
', `
...
rule ld_lib
__HACK_SPACE`'command=__BASE_LD_RULE __LD_FLAGS_LIB __LD_IN_FLAGS_LIB($in)
rule symlink
...
__HACK_SPACE`'description=CPP __SRC_FILE
			...
			m4_define(`__CXX_DEPFILE', `')
			m4_define(`__CXX_DEPS', `')
		')

m4_include(__private/cxx_file.m4)
...
build __TMP_LIBRARY_PATH/$1.__SO_EXT: ld_lib __TMP_OBJLIST | m4_defn(__`'PROJECT`'_LD_FILES) m4_defn(`__LIBRARY_LD_FILES')
__HACK_SPACE`'ldflags=$ldflags __REVERSE(m4_defn(__`'PROJECT`'_LD_FILES)) __REVERSE(m4_defn(`__LIBRARY_LD_FILES')) m4_defn(__`'PROJECT`'_LD_LIBS) m4_defn(`__LIBRARY_LD_LIBS')
m4_indir(`__COLLECT_WARNINGS_FILE__')
...
build __TMP_LIBRARY_PATH/$1.__EXEC_EXT: ld_exec __TMP_OBJLIST | m4_defn(__`'PROJECT`'_LD_FILES) m4_defn(`__LIBRARY_LD_FILES')
__HACK_SPACE`'ldflags=$ldflags __REVERSE(m4_defn(__`'PROJECT`'_LD_FILES)) __REVERSE(m4_defn(`__LIBRARY_LD_FILES')) m4_defn(__`'PROJECT`'_LD_LIBS) m4_defn(`__LIBRARY_LD_LIBS')
m4_indir(`__COLLECT_WARNINGS_FILE__')
__HACK_SPACE`'description=`LD' $1
...
m4_define(LIBRARY_FLAGS, `
	...
	m4_define(__LIBRARY_CPP_FLAGS, m4_defn(`CPP_FLAGS'))
	m4_define(__LIBRARY_M4_FLAGS, m4_defn(`M4_FLAGS'))
...
m4_define(PROJECT_FLAGS, `
	...
	m4_define(__`'PROJECT`'_CPP_FLAGS, m4_defn(`CPP_FLAGS'))
	m4_define(__`'PROJECT`'_M4_FLAGS, m4_defn(`M4_FLAGS'))
...
m4_define(FILE_FLAGS, `
	...
	m4_define(__`'__SRC_HASH`'_CPP_FLAGS, m4_defn(`CPP_FLAGS'))
	m4_define(__`'__SRC_HASH`'_M4_FLAGS, m4_defn(`M4_FLAGS'))
...
m4_define(DECLARE_DEPENDENCY, `
	...
	m4_define(m4_defn(`__DEP_DEFINE_NAME')_CPP_FLAGS, m4_defn(`CPP_FLAGS'))
	m4_define(m4_defn(`__DEP_DEFINE_NAME')_LD_LIBS, m4_defn(`LD_LIBS'))
	m4_define(m4_defn(`__DEP_DEFINE_NAME')_LD_FILES, m4_defn(`LD_FILES'))
...
m4_define(__DEPENDENCY, `
	...
	m4_define(`$1_CPP_FLAGS', m4_defn(`$1_CPP_FLAGS') m4_defn(m4_defn(`__DEP_DEFINE_NAME')_CPP_FLAGS))
	m4_define(`$1_LD_LIBS', m4_defn(`$1_LD_LIBS') m4_defn(m4_defn(`__DEP_DEFINE_NAME')_LD_LIBS))
	m4_define(`$1_LD_FILES', m4_defn(`$1_LD_FILES') m4_defn(m4_defn(`__DEP_DEFINE_NAME')_LD_FILES))
...
m4_define(FILE_DEPENDENCIES, `
	...
	')
	m4_define(__`'__SRC_HASH`'_DEPS, __TMP_OUTFILES)
	m4_undefine(`__SRC_FILE')
	m4_undefine(`__SRC_HASH')
...
m4_define(FILE_DEPENDENCIES_INVERSE, `
	...
	FOREACH(`__FILES_IT', (m4_shift($@)), `
		m4_define(`__SRC_FILE', ABSOLUTE_PATH(__FILES_IT, m, false))
		m4_define(`__SRC_HASH', __HASH(__SRC_FILE))
		m4_define(__`'__SRC_HASH`'_DEPS, __OUT_FILE)
		m4_undefine(`__SRC_FILE')
		m4_undefine(`__SRC_HASH')
	')
