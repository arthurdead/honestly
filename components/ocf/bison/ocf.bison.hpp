...
#line 16 "/hd2/honestly/components/ocf/bison/ocf.bison"
...
#line 39 "/hd2/honestly/components/ocf/bison/ocf.bison"

#include <ctl/string>
#include <ctl/variant>
#include <ctl/cstddef>

#line 62 "ocf.bison.hpp"
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
...
#else
    typedef OCFSTYPE semantic_type;
#endif
    /// Symbol locations.
    ...
    U8STRING_LITERAL = 5,          // U8STRING_LITERAL
    U16STRING_LITERAL = 6,         // U16STRING_LITERAL
    U32STRING_LITERAL = 7,         // U32STRING_LITERAL
    WSTRING_LITERAL = 8,           // WSTRING_LITERAL
    CHAR_LITERAL = 9,              // CHAR_LITERAL
    U8CHAR_LITERAL = 10,           // U8CHAR_LITERAL
    U16CHAR_LITERAL = 11,          // U16CHAR_LITERAL
    U32CHAR_LITERAL = 12,          // U32CHAR_LITERAL
    WCHAR_LITERAL = 13,            // WCHAR_LITERAL
    OPEN_BRACE = 14,               // OPEN_BRACE
    CLOSE_BRACE = 15,              // CLOSE_BRACE
    OPEN_BRACKET = 16,             // OPEN_BRACKET
    CLOSE_BRACKET = 17,            // CLOSE_BRACKET
    OPEN_PARENTHESIS = 18,         // OPEN_PARENTHESIS
    CLOSE_PARENTHESIS = 19,        // CLOSE_PARENTHESIS
    PLUS = 20,                     // PLUS
    MINUS = 21,                    // MINUS
    DIVIDE = 22,                   // DIVIDE
    MULTIPLY = 23,                 // MULTIPLY
    EQUAL = 24,                    // EQUAL
    LOGICAL_NOT = 25,              // LOGICAL_NOT
    COLON = 26,                    // COLON
    SEMICOLON = 27,                // SEMICOLON
    TERNARY = 28,                  // TERNARY
    MODULO = 29,                   // MODULO
    BITWISE_OR = 30,               // BITWISE_OR
    BITWISE_AND = 31,              // BITWISE_AND
    BITWISE_XOR = 32,              // BITWISE_XOR
    LESSER = 33,                   // LESSER
    GREATER = 34,                  // GREATER
    BITWISE_NOT = 35,              // BITWISE_NOT
    COMMA = 36,                    // COMMA
    DOT = 37,                      // DOT
    DOUBLE_COLON = 38,             // DOUBLE_COLON
    PLUS_PLUS = 39,                // PLUS_PLUS
    MINUS_MINUS = 40,              // MINUS_MINUS
    THIS = 41,                     // THIS
    BOOL_LITERAL = 42,             // BOOL_LITERAL
    INT_LITERAL = 43,              // INT_LITERAL
    LONG_LITERAL = 44,             // LONG_LITERAL
    LONG_LONG_LITERAL = 45,        // LONG_LONG_LITERAL
    SIZE_LITERAL = 46,             // SIZE_LITERAL
    UNSIGNED_INT_LITERAL = 47,     // UNSIGNED_INT_LITERAL
    UNSIGNED_LONG_LITERAL = 48,    // UNSIGNED_LONG_LITERAL
    UNSIGNED_LONG_LONG_LITERAL = 49, // UNSIGNED_LONG_LONG_LITERAL
    UNSIGNED_SIZE_LITERAL = 50,    // UNSIGNED_SIZE_LITERAL
    DOUBLE_LITERAL = 51,           // DOUBLE_LITERAL
    LONG_DOUBLE_LITERAL = 52,      // LONG_DOUBLE_LITERAL
    FLOAT_LITERAL = 53             // FLOAT_LITERAL
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_U8STRING_LITERAL = 5,                  // U8STRING_LITERAL
        S_U16STRING_LITERAL = 6,                 // U16STRING_LITERAL
        S_U32STRING_LITERAL = 7,                 // U32STRING_LITERAL
        S_WSTRING_LITERAL = 8,                   // WSTRING_LITERAL
        S_CHAR_LITERAL = 9,                      // CHAR_LITERAL
        S_U8CHAR_LITERAL = 10,                   // U8CHAR_LITERAL
        S_U16CHAR_LITERAL = 11,                  // U16CHAR_LITERAL
        S_U32CHAR_LITERAL = 12,                  // U32CHAR_LITERAL
        S_WCHAR_LITERAL = 13,                    // WCHAR_LITERAL
        S_OPEN_BRACE = 14,                       // OPEN_BRACE
        S_CLOSE_BRACE = 15,                      // CLOSE_BRACE
        S_OPEN_BRACKET = 16,                     // OPEN_BRACKET
        S_CLOSE_BRACKET = 17,                    // CLOSE_BRACKET
        S_OPEN_PARENTHESIS = 18,                 // OPEN_PARENTHESIS
        S_CLOSE_PARENTHESIS = 19,                // CLOSE_PARENTHESIS
        S_PLUS = 20,                             // PLUS
        S_MINUS = 21,                            // MINUS
        S_DIVIDE = 22,                           // DIVIDE
        S_MULTIPLY = 23,                         // MULTIPLY
        S_EQUAL = 24,                            // EQUAL
        S_LOGICAL_NOT = 25,                      // LOGICAL_NOT
        S_COLON = 26,                            // COLON
        S_SEMICOLON = 27,                        // SEMICOLON
        S_TERNARY = 28,                          // TERNARY
        S_MODULO = 29,                           // MODULO
        S_BITWISE_OR = 30,                       // BITWISE_OR
        S_BITWISE_AND = 31,                      // BITWISE_AND
        S_BITWISE_XOR = 32,                      // BITWISE_XOR
        S_LESSER = 33,                           // LESSER
        S_GREATER = 34,                          // GREATER
        S_BITWISE_NOT = 35,                      // BITWISE_NOT
        S_COMMA = 36,                            // COMMA
        S_DOT = 37,                              // DOT
        S_DOUBLE_COLON = 38,                     // DOUBLE_COLON
        S_PLUS_PLUS = 39,                        // PLUS_PLUS
        S_MINUS_MINUS = 40,                      // MINUS_MINUS
        S_THIS = 41,                             // THIS
        S_BOOL_LITERAL = 42,                     // BOOL_LITERAL
        S_INT_LITERAL = 43,                      // INT_LITERAL
        S_LONG_LITERAL = 44,                     // LONG_LITERAL
        S_LONG_LONG_LITERAL = 45,                // LONG_LONG_LITERAL
        S_SIZE_LITERAL = 46,                     // SIZE_LITERAL
        S_UNSIGNED_INT_LITERAL = 47,             // UNSIGNED_INT_LITERAL
        S_UNSIGNED_LONG_LITERAL = 48,            // UNSIGNED_LONG_LITERAL
        S_UNSIGNED_LONG_LONG_LITERAL = 49,       // UNSIGNED_LONG_LONG_LITERAL
        S_UNSIGNED_SIZE_LITERAL = 50,            // UNSIGNED_SIZE_LITERAL
        S_DOUBLE_LITERAL = 51,                   // DOUBLE_LITERAL
        S_LONG_DOUBLE_LITERAL = 52,              // LONG_DOUBLE_LITERAL
        S_FLOAT_LITERAL = 53,                    // FLOAT_LITERAL
        S_YYACCEPT = 54,                         // $accept
        S_string_literal = 55,                   // string_literal
        S_literal = 56,                          // literal
        S_57_identifier_literal = 57,            // identifier.literal
        S_58_identifier_string_literal = 58,     // identifier.string_literal
        S_object_value = 59,                     // object_value
        S_object_group_header = 60,              // object_group_header
        S_object_attributes = 61,                // object_attributes
        S_62_1 = 62,                             // $@1
        S_63_2 = 63,                             // $@2
        S_64_object_attributes_opt = 64,         // object_attributes.opt
        S_65_object_group_loop_impl = 65,        // object_group.loop_impl
        S_66_object_group_loop = 66,             // object_group.loop
        S_object_inherit_namespace_header = 67,  // object_inherit_namespace_header
        S_68_object_inherit_namespace_loop = 68, // object_inherit_namespace.loop
        S_object_inherit_header = 69,            // object_inherit_header
        S_70_object_inherit_loop_impl = 70,      // object_inherit.loop_impl
        S_71_object_inherit_loop = 71,           // object_inherit.loop
        S_this = 72,                             // this
        S_object_header_simple = 73,             // object_header_simple
        S_object_namespace_header = 74,          // object_namespace_header
        S_75_object_namespace_loop = 75,         // object_namespace.loop
        S_object_namespace = 76,                 // object_namespace
        S_object_header_nosimple = 77,           // object_header_nosimple
        S_object_header = 78,                    // object_header
        S_object_inherit = 79,                   // object_inherit
        S_80_object_body_opt = 80,               // object_body.opt
        S_81_object_end = 81,                    // object.end
        S_82_object_end_simple = 82,             // object.end_simple
        S_object_section_begin = 83,             // object_section_begin
        S_84_3 = 84,                             // $@3
        S_85_4 = 85,                             // $@4
        S_object_section = 86,                   // object_section
        S_object_section_end = 87,               // object_section_end
        S_object = 88,                           // object
        S_array_pair = 89,                       // array_pair
        S_90_comma_opt = 90,                     // comma.opt
        S_91_array_level_loop_impl = 91,         // array_level.loop_impl
        S_92_array_level_loop = 92,              // array_level.loop
        S_object_body = 93,                      // object_body
        S_array_body = 94,                       // array_body
        S_95_semicolon_opt = 95,                 // semicolon.opt
        S_top_level = 96,                        // top_level
        S_97_top_level_loop = 97,                // top_level.loop
        S_main = 98                              // main
      };
    };
...
switch (yykind)
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
...
#endif
      {
        OCF_ASSERT (tok == token::OCFEOF
                   || (token::OCFerror <= tok && tok <= token::OCFUNDEF)
                   || (token::OPEN_BRACE <= tok && tok <= token::THIS));
      }
#if 201103L <= YY_CPLUSPLUS
...
#endif
      {
        OCF_ASSERT ((token::LONG_LONG_LITERAL <= tok && tok <= token::SIZE_LITERAL));
      }
#if 201103L <= YY_CPLUSPLUS
...
#endif
      {
        OCF_ASSERT ((token::IDENTIFIER <= tok && tok <= token::STRING_LITERAL));
      }
#if 201103L <= YY_CPLUSPLUS
...
#endif
      {
        OCF_ASSERT ((token::UNSIGNED_LONG_LONG_LITERAL <= tok && tok <= token::UNSIGNED_SIZE_LITERAL));
      }
#if 201103L <= YY_CPLUSPLUS
    ...
    parser (ocf::__private::lexer &__lex_yyarg, ocf::__private::driver &__drv_yyarg);
    virtual ~parser ();
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_SIZE_LITERAL (long long v, location_type l)
      {
      ...
      static
      symbol_type
      make_SIZE_LITERAL (const long long& v, const location_type& l)
      {
      ...
      static
      symbol_type
      make_UNSIGNED_SIZE_LITERAL (unsigned long long v, location_type l)
      {
        return symbol_type (token::UNSIGNED_SIZE_LITERAL, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_UNSIGNED_SIZE_LITERAL (const unsigned long long& v, const location_type& l)
      {
        return symbol_type (token::UNSIGNED_SIZE_LITERAL, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
  ...
  private:
    ...
    // User arguments.
    ocf::__private::lexer &__lex;
    ocf::__private::driver &__drv;
