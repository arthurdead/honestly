...
m4_define(__API_BRIDGE_HANDLE_BEGIN, `
	m4_ifelse(
	$1, PUBLIC, `
		m4_define(`__API_BRIDGE_FUNC_API', m4_defn(`API_BRIDGE_FUNC_API'))
		m4_define(`__API_BRIDGE_FUNC_CALL', m4_defn(`API_BRIDGE_FUNC_CALL'))
...
m4_ifelse(API_BRIDGE_TYPE, PRIVATE, `
	m4_define(API_BRIDGE, `BEGIN_NO_OUTPUT
