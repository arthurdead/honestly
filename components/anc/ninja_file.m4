m4_define(__DETAIL_SCRIPT, __ANC_DIR/__details/$1.sh)

m4_define(__HOST_ARCH, m4_esyscmd(__DETAIL_SCRIPT(host_arch)))
m4_define(__HOST_DIST, m4_esyscmd(__DETAIL_SCRIPT(host_dist)))

m4_ifelse(__HOST_ARCH, x86-64, `
	
', `
	m4_errprint(unsupported host archtecture: __HOST_ARCH
)
	m4_m4exit(1)
')
...
', `
	m4_errprint(unsupported host distribution: __HOST_DIST
)
	m4_m4exit(1)
')

m4_undefine(`__DETAIL_SCRIPT')
m4_include(helpers.m4)

m4_define(__HASH, `m4_esyscmd(__DETAIL_SCRIPT(hash) "$1")')
m4_define(__C_VERSION, `m4_esyscmd(__DETAIL_SCRIPT(c_version) $1)')
m4_define(__BASE_PATH, `m4_esyscmd(dirname $1)')
m4_define(__REVERSE, `m4_esyscmd(__DETAIL_SCRIPT(reverse) $@)')
m4_define(__REMOVE_WHITESPACE, `m4_esyscmd(__DETAIL_SCRIPT(remove_whitespace) $1)')
...
m4_include(__details/options.m4)
m4_include(__details/sanity.m4)
...
m4_ifdef(`COLLECT_WARNED', `
	m4_define(__COLLECT_WARNED_EXEC, __COLLECT_WARNINGS_FILE=$__COLLECT_WARNINGS_FILE __COLLECT_WARNINGS_OUTPUT=$__COLLECT_WARNINGS_OUTPUT __DETAIL_SCRIPT(collect_warned))
...
m4_include(__details/architecture.m4)
m4_include(__details/librt.m4)
m4_include(__details/libcpp.m4)
m4_include(__details/libc.m4)
...
m4_include(__details/default_flags.m4)

m4_include(__details/toolset_mods.m4)
...
m4_include(__details/toolset.m4)
m4_include(__details/ccache.m4)
...
m4_define(`__CC_CPP_FLAGS', m4_defn(`__CC_CPP_FLAGS') __SYSTEM_INC_DIRS $c_inc_override __LIBC_INC_DIRS __TOOLSET_INC_DIRS)
m4_define(`__CXX_CPP_FLAGS', m4_defn(`__CXX_CPP_FLAGS') __SYSTEM_INC_DIRS $cxx_inc_override __LIBCPP_INC_DIRS $c_inc_override __LIBC_INC_DIRS __TOOLSET_INC_DIRS)
...
')
m4_define(`THIRDPARTY_CPP_FLAGS', m4_defn(`THIRDPARTY_CPP_FLAGS') -Wno-undef)
...
m4_include(__details/loop_c_files.m4)
